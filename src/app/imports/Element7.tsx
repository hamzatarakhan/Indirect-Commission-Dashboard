...
export default function Element17() {
  return (
    <div
      className="bg-[#ffffff] relative rounded-2xl size-full"
      data-name="ELEMENT 7"
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-3 items-start justify-start overflow-clip p-[24px] relative size-full">
