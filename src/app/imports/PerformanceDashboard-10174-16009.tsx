import svgPaths from "./svg-3hsln12lzt";
...
export default function PerformanceDashboard() {
  return (
    <div className="bg-slate-50 relative rounded-[12.75px] size-full" data-name="PerformanceDashboard">
      <div aria-hidden="true" className="absolute border-[0.8px] border-slate-200 border-solid inset-0 pointer-events-none rounded-[12.75px]" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center pl-[14.8px] pr-[0.8px] py-[0.8px] relative size-full">
          <Container4 />
        </div>
      </div>
    </div>
