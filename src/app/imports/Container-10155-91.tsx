import svgPaths from "./svg-1pzi11zc2a";
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p317fdd80} id="Vector" stroke="var(--stroke-0, #009966)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d={svgPaths.p31c78b80} id="Vector_2" stroke="var(--stroke-0, #009966)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M11.0833 4.66667V8.16667" id="Vector_3" stroke="var(--stroke-0, #009966)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M12.8333 6.41667H9.33333" id="Vector_4" stroke="var(--stroke-0, #009966)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
      </svg>
    </div>
  );
...
function CustomerBaseMatrix() {
  return (
    <div className="bg-[#d0fae5] content-stretch flex items-center justify-center relative rounded-[8.75px] shrink-0 size-[31.5px]" data-name="CustomerBaseMatrix">
      <Icon />
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex h-[15px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arial:Bold',sans-serif] grow leading-[15px] min-h-px min-w-px not-italic relative shrink-0 text-[#6a7282] text-[10px] tracking-[0.5px] uppercase">ACTIVATION</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="content-stretch flex h-[15px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Arial:Regular',sans-serif] leading-[15px] not-italic relative shrink-0 text-[#6a7282] text-[10px] text-nowrap whitespace-pre">8.50M OMR</p>
    </div>
  );
}
...
export default function Container4() {
  return (
    <div className="bg-[#f6fefa] relative rounded-[12.75px] size-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(164,244,207,0.5)] border-solid inset-0 pointer-events-none rounded-[12.75px]" />
