...
export function ProductRevenueCard({
  title,
  icon: Icon,
  totalRevenue,
  monthlyData,
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-xl border transition-all duration-300 bg-white dark:bg-[#07112F] hover:shadow-md border-gray-200 dark:border-gray-700/50 hover:border-opacity-80"
    >
      <div className="p-6 space-y-5">
        {/* Header */}
        <div className="flex items-start gap-3 w-full">
          <div className="p-3 rounded-xl shrink-0" style={{ backgroundColor: lightenColor(color, 85) }}>
